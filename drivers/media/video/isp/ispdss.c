...
{
	if (dev_ctx.opened) {
		//dev_err(NULL, "dss: get_resource: device is already opened\n"); //by crystal.moon for meridian player patch in HUB 2010.12.08
		return -EBUSY;
	}
...
//LGE_CHANGE_S [ajit.saunshikar@lge.com] 2011_07_19 Froyo_to_GB
	struct device *dev = to_device(isp_res);
//LGE_CHANGE_E [ajit.saunshikar@lge.com] 2011_07_19 Froyo_to_GB
