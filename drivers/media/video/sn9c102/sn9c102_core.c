...
static DEVICE_ATTR(green, S_IWGRP | S_IWUSR, NULL, sn9c102_store_green);
static DEVICE_ATTR(blue, S_IWGRP | S_IWUSR, NULL, sn9c102_store_blue);
static DEVICE_ATTR(red, S_IWGRP | S_IWUSR, NULL, sn9c102_store_red);
