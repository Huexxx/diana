...
/* LGE_CHANGE_S, hj.eum@lge.com, 2011-07-05, patch from TI(Tushar) - OMAPS00243118 */
#if 0 // Tushar - OMAPS00243118 - [
	...
	if ((vout->pix.height * vout->pix.width == VID_MAX_WIDTH * 720) || 
	    ...
	    (vout->pix.width > 864))
		return true;
#endif // Tushar - OMAPS00243118 - ]
/* LGE_CHANGE_E, hj.eum@lge.com, 2011-07-05, patch from TI(Tushar) - OMAPS00243118 */
	return false;
}
