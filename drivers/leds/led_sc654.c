...
DEVICE_ATTR(led_level_1, 0664, key_led1_show_level, key_led1_store_level);
DEVICE_ATTR(led_level_2, 0664, key_led2_show_level, key_led2_store_level);
DEVICE_ATTR(fade_state, 0664, NULL, fade_state_store);
