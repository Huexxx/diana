...
static int wifi_probe(struct platform_device *pdev)
{
	...
	printk("## %s\n", __FUNCTION__);
	//wifi_irqres = platform_get_resource_byname(pdev, IORESOURCE_IRQ, "bcm4329_wlan_irq"); // louislee
 ...
 */
char firmware_path[MOD_PARAM_PATHLEN]="/system/etc/wifi/fw_bcm4329.bin"; // louislee
...
// bill.jung@lge.com - Remote DHCP Server issue.(Bridge AP)
#if 0
#ifdef PKT_FILTER_SUPPORT
	DHD_TRACE(("%s: %d\n", __FUNCTION__, value));
...
#if 0 /* defined(CONFIG_MACH_MAHIMAHI) && defined(CONFIG_WIFI_CONTROL_FUNC) */
