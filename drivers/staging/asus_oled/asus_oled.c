...
static DEVICE_ATTR(asus_oled_enabled, S_IWGRP | S_IWUSR | S_IRUGO,
		   get_enabled, set_enabled);
static DEVICE_ATTR(asus_oled_picture, S_IWGRP | S_IWUSR , NULL, set_picture);

static DEVICE_ATTR(enabled, S_IWGRP | S_IWUSR | S_IRUGO,
		   class_get_enabled, class_set_enabled);
static DEVICE_ATTR(picture, S_IWGRP | S_IWUSR, NULL, class_set_picture);
