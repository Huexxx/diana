...
static int acm_setup(struct usb_function *f, const struct usb_ctrlrequest *ctrl)
{
	...
	case ((USB_DIR_OUT | USB_TYPE_CLASS | USB_RECIP_INTERFACE) << 8)
		...
		//LGE_UPDATE_S 20110214 [jaejoong.kim@lge.com] usb rndis porting for B project GB
...
// LGE_UPDATE_S 20110324 [jaejoong.kim@lge.com] force enable when started
/*
 	If there is usb mode change, this code may change.
	In Docomo B project, we don't need usb mode change
*/
	/* start disabled */
