		...
		const char *buf, size_t size)
{
	...
	//LGE_UPDATE_S 20110122 jaejoong.kim@lge.com Debug usb porting for B project GB
...
/* LGE_CHANGE_START 2011-03-18 kenneth.kang@lge.com - Fix : kernel panic occured by memcpy in composite_setup */
			printk("composite_setup : USB_DT_DEVICE : req->buf = 0x%x\n", req->buf);
			if(req->buf < 0xc0000000) {
				printk("composite_setup : USB_DT_DEVICE : error!! req->buff is userspace address!!\n");
				return 0;
			}
/* LGE_CHANGE_END 2011-03-18 kenneth.kang@lge.com */			
			else				
