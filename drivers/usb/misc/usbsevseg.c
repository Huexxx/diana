...
static DEVICE_ATTR(name, S_IWGRP | S_IWUSR | S_IRUGO, show_attr_##name, set_attr_##name);
...
static DEVICE_ATTR(text, S_IWGRP | S_IWUSR | S_IRUGO, show_attr_text, set_attr_text);
...
static DEVICE_ATTR(decimals, S_IWGRP | S_IWUSR | S_IRUGO,
...
static DEVICE_ATTR(textmode, S_IWGRP | S_IWUSR | S_IRUGO,
