...
// LGE_UPDATE_S : move to pm.c
#if defined(CONFIG_MACH_LGE_OMAP3)
#else
u32 enable_off_mode;
u32 sleep_while_idle;
#endif
// LGE_UPDATE_E : move to pm.c
...
#endif
// prime@sdcmicro.com Added PM dump for core, per, usghost domains [START]
#if 1 //prime@sdcmicro.com patch for usb 20110403
		//core
		DUMP_CM_MOD_REG(CORE_MOD, CM_CLKEN);
		DUMP_CM_MOD_REG(CORE_MOD, CM_ICLKEN);
		DUMP_CM_MOD_REG(CORE_MOD, CM_IDLEST);
		DUMP_CM_MOD_REG(CORE_MOD, CM_AUTOIDLE);
		DUMP_CM_MOD_REG(CORE_MOD, CM_CLKSEL);
		DUMP_CM_MOD_REG(CORE_MOD, OMAP2_CM_CLKSTCTRL);
		DUMP_PRM_MOD_REG(CORE_MOD, OMAP2_RM_RSTCTRL);
		DUMP_PRM_MOD_REG(CORE_MOD, OMAP2_RM_RSTST);
		DUMP_PRM_MOD_REG(CORE_MOD, OMAP2_PM_PWSTCTRL);
		DUMP_PRM_MOD_REG(CORE_MOD, OMAP2_PM_PWSTST);
		DUMP_PRM_MOD_REG(CORE_MOD, OMAP3430_PM_PREPWSTST);
		DUMP_PRM_MOD_REG(CORE_MOD, OMAP3430_PM_IVAGRPSEL);
		DUMP_PRM_MOD_REG(CORE_MOD, OMAP3430_PM_MPUGRPSEL);
		DUMP_PRM_MOD_REG(CORE_MOD, OMAP2_RM_RSTST);
		DUMP_PRM_MOD_REG(CORE_MOD, PM_WKDEP);
		DUMP_PRM_MOD_REG(CORE_MOD, PM_WKST);
		DUMP_PRM_MOD_REG(CORE_MOD, PM_WKEN);
		//per
		DUMP_CM_MOD_REG(OMAP3430_PER_MOD, CM_CLKEN);
		DUMP_CM_MOD_REG(OMAP3430_PER_MOD, CM_ICLKEN);
		DUMP_CM_MOD_REG(OMAP3430_PER_MOD, CM_AUTOIDLE);
		//usbhost
		DUMP_CM_MOD_REG(OMAP3430ES2_USBHOST_MOD, CM_CLKEN);
		DUMP_CM_MOD_REG(OMAP3430ES2_USBHOST_MOD, CM_ICLKEN);
		DUMP_CM_MOD_REG(OMAP3430ES2_USBHOST_MOD, CM_IDLEST);
		DUMP_CM_MOD_REG(OMAP3430ES2_USBHOST_MOD, CM_AUTOIDLE);
#endif
// prime@sdcmicro.com Added PM dump for core, per, usghost domains [END]
