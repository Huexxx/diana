...
/* 20100623 kyungtae.oh@lge.com hub use DSI MIPI [LGE_START]*/
...
static struct omap_dss_device *hub_dss_devices[] = {
	&hub_lcd_device,
	//&hub_tv_device, //20100623 kyungtae.oh@lge.com hub didn't use tv
...
// prime@sdcmicro.com Removed old function from 2.6.32 [START]
//extern unsigned get_last_off_on_transaction_id(struct device *dev);
// prime@sdcmicro.com Removed old function from 2.6.32 [END]
...
static int hub_panel_enable_lcd(struct omap_dss_device *dssdev)
{
	...
	hub_lcd_initialize(); /* 20110304 seven.kim@lge.com late_resume_lcd [START] */
...
static void hub_panel_disable_lcd(struct omap_dss_device *dssdev)
{
	aat2870_shutdown(); /* 20110304 seven.kim@lge.com late_resume_lcd [START] */
